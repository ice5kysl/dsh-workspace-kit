...
var styles = {
  ...
  input: {
    ...
    padding: "7px 10px",
    borderRadius: 8,
    border: "1px solid var(--dsw-alias-border-l2, rgba(28, 35, 51, 0.2))",
    outline: "none",
    marginBottom: 12,
  ...
  button: {
    ...
    padding: "5px 14px",
    borderRadius: 8,
    border: "1px solid var(--dsw-alias-border-l2, rgba(28, 35, 51, 0.14))",
    background: "var(--dsw-alias-bg-layer-1, #ffffff)",
    color: "var(--dsw-alias-label-primary, #3c4659)",
    cursor: "pointer"
  },
  primary: {
    background: "var(--dsw-alias-button-primary-fill, #2d66f7)",
...
var styles3 = {
  ...
  expandArchived: {
    ...
    background: "var(--dsw-alias-bg-layer-1, #f5f7fa)",
    cursor: "pointer",
    textAlign: "center"
  },
  footer: {
...
var styles4 = {
  ...
  miniButton: {
    ...
    padding: "0 6px",
    borderRadius: 6,
    border: "1px solid var(--dsw-alias-border-l2, rgba(28, 35, 51, 0.12))",
    background: "var(--dsw-alias-bg-layer-1, #ffffff)",
    color: "var(--dsw-alias-label-secondary, #5a6478)",
    cursor: "pointer",
    display: "inline-flex",
  ...
  pickerPanel: {
    ...
    borderRadius: 10,
    background: "var(--dsw-alias-bg-layer-1, #f5f7fa)",
    border: "1px solid var(--dsw-alias-border-l1, rgba(28, 35, 51, 0.08))"
  },
