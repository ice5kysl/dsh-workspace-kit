...
function DialogHost() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.backdrop, onMouseDown: () => settle(null), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.card, role: "dialog", "aria-label": request.title, onMouseDown: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.actions, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: styles.button, onClick: () => settle(null), children: request.kind === "confirm" ? "\u53D6\u6D88" : "\u53D6\u6D88" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: request.okLabel ?? (request.kind === "confirm" ? "\u786E\u5B9A" : "\u786E\u5B9A")
        }
      )
    ] })
  ] }) });
...
function SidebarToggle(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "button",
    {
      ...
      title: official ? "\u5F53\u524D\u4E3A\u5B98\u65B9\u4FA7\u680F \u2014\u2014 \u70B9\u51FB\u5207\u6362\u5230\u589E\u5F3A\u4FA7\u680F\uFF08\u5F52\u6863\u6298\u53E0 / \u62D6\u62FD\u6392\u5E8F / \u56FE\u6807\u989C\u8272\uFF09" : "\u5F53\u524D\u4E3A\u589E\u5F3A\u4FA7\u680F \u2014\u2014 \u70B9\u51FB\u5207\u6362\u5230\u5B98\u65B9\u4FA7\u680F",
      onClick: toggle,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: styles2.glyph, children: official ? "\u25D0" : "\u25D1" }),
        wide && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: official ? "\u589E\u5F3A\u4FA7\u680F" : "\u5B98\u65B9\u4FA7\u680F" })
      ]
    }
  );
}
...
function buildSections(query, sessionsState, workspacesState, archived, showArchived, kind) {
  ...
  if (searching) {
    ...
    if (showWorkspaces && wsRows.length > 0) secs2.push({ key: "workspaces", label: "\u5DE5\u4F5C\u533A", rows: wsRows });
    if (showSessions && sessions.length > 0) secs2.push({ key: "sessions", label: "\u4F1A\u8BDD", rows: sessions });
    return secs2;
  }
  const secs = [];
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: styles3.chips, children: ["all", "workspaces", "sessions"].map((k) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            ...
            children: k === "all" ? "\u5168\u90E8" : k === "workspaces" ? "\u5DE5\u4F5C\u533A" : "\u4F1A\u8BDD"
          },
          k
        )) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: styles3.body, children: [
          rowCount === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: styles3.empty, children: query.trim() ? `\u6CA1\u6709\u5339\u914D\u300C${query}\u300D\u7684\u5DE5\u4F5C\u533A\u6216\u4F1A\u8BDD` : "\u8FD8\u6CA1\u6709\u5DE5\u4F5C\u533A\u3002\u4ECE\u4E00\u4E2A\u9879\u76EE\u76EE\u5F55\u5F00\u59CB\u4F1A\u8BDD\u540E\u4F1A\u81EA\u52A8\u51FA\u73B0\u3002" }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: styles3.rowMain, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: styles3.rowTitle, children: [
                          ...
                          isArchivedWs && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: styles3.badgeArchived, children: "\u5DF2\u5F52\u6863" }),
                          row.kind === "session" && row.running && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: styles3.badgeRunning, children: "\u8FD0\u884C\u4E2D" })
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: styles3.rowSub, children: row.kind === "workspace" ? `${row.path} \xB7 ${row.sessionCount} \u4E2A\u4F1A\u8BDD \xB7 ${row.updatedAt.slice(0, 10)}` : row.cwd ?? "" })
                      ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: styles3.footer, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u2191\u2193 \u9009\u62E9" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u21B5 \u6253\u5F00" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: searching ? `${rowCount} \u4E2A\u5339\u914D` : `${rowCount} \u9879` }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { marginLeft: "auto" }, children: "Esc \u5173\u95ED" })
        ] })
      ]
    }
  ) });
...
function WorkspaceSidebar(props) {
  ...
  if (!wide) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.rail, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.railButton, title: "Spotlight \u641C\u7D22\uFF08\u2318K\uFF09", onClick: openSpotlight, children: "\u2318" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.railButton, title: "\u5C55\u5F00\u4FA7\u680F", onClick: expandSidebar, children: "\xBB" })
    ] });
  }
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "span",
            {
              ...
              onMouseDown: (e) => e.stopPropagation(),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u91CD\u547D\u540D", onClick: (e) => {
                  e.stopPropagation();
                  void renameSession(s.id, s.title);
                }, children: "\u270E" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u590D\u5236\u4F1A\u8BDD\uFF08fork\uFF09", onClick: (e) => {
                  e.stopPropagation();
                  forkSession(s.id);
                }, children: "\u29C9" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u5F52\u6863\u4F1A\u8BDD\uFF08\u4E0D\u53EF\u9006\uFF0C\u4ECD\u53EF\u4ECE\u641C\u7D22\u6253\u5F00\uFF09", onClick: (e) => {
                  e.stopPropagation();
                  archiveSession(s.id);
                }, children: "\u5F52\u6863" })
              ]
  ...
  const renderWsRow = (ws, draggable) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: { ...styles4.wsActions, display: hovered === wsKey ? "flex" : "none" }, onMouseDown: (e) => e.stopPropagation(), children: [
              ...
              !ws.archived && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u5728\u6B64\u5DE5\u4F5C\u533A\u65B0\u5EFA\u4F1A\u8BDD", onClick: (e) => {
                e.stopPropagation();
                startSession(ws.id);
              }, children: "\uFF0B" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  ...
                  children: ws.archived ? "\u6062\u590D" : "\u5F52\u6863"
                }
              ),
              !ws.archived && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u91CD\u547D\u540D\u5DE5\u4F5C\u533A", onClick: (e) => {
                e.stopPropagation();
                void renameWorkspace(ws.id, ws.title);
              }, children: "\u270E" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.miniButton, title: "\u5220\u9664\u5DE5\u4F5C\u533A\u6CE8\u518C\uFF08\u76EE\u5F55\u4E0E\u5386\u53F2\u4F1A\u8BDD\u4FDD\u7559\uFF09", onClick: (e) => {
                e.stopPropagation();
      ...
      picking && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.pickerPanel, onMouseDown: (e) => e.stopPropagation(), children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.pickerLabel, children: "\u56FE\u6807" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.pickerLabel, children: "\u989C\u8272" }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.root, onMouseLeave: () => setHovered(null), children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: styles4.headerTitle, children: "\u5DE5\u4F5C\u533A" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: styles4.headerActions, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.headerAction, title: "\u65B0\u5EFA\u5DE5\u4F5C\u533A\uFF08\u9009\u62E9\u76EE\u5F55\uFF09", onClick: addWorkspace, children: "\uFF0B" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { style: styles4.headerAction, title: "Spotlight\uFF08\u2318K\uFF09", onClick: openSpotlight, children: "\u2318" })
      ] })
    ] }),
    ...
    !searching && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.viewPills, children: [
      ...
      viewMode === "grouped" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "button",
        {
          ...
          children: sortMode === "updated" ? "\u6392\u5E8F:\u6700\u8FD1\u66F4\u65B0" : "\u6392\u5E8F:\u624B\u52A8"
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.scroll, children: searching ? searchHits.length === 0 && contentHits.length === 0 && !contentLoading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.empty, children: [
      "\u6CA1\u6709\u5339\u914D\u300C",
      searchQ.trim(),
      "\u300D\u7684\u5DE5\u4F5C\u533A\u6216\u4F1A\u8BDD"
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      contentLoading && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.empty, children: "\u6B63\u5728\u641C\u7D22\u4F1A\u8BDD\u5185\u5BB9\u2026" }),
      ...
      contentHits.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.contentLabel, children: [
          "\u4F1A\u8BDD\u5185\u5BB9\u547D\u4E2D\uFF08",
          contentHits.length,
          "\uFF09"
        ] }),
    ...
    ] }) : viewMode === "flat" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.flatWrap, children: flatSessions.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.empty, children: "\u8FD8\u6CA1\u6709\u4F1A\u8BDD\u3002" }) : renderSessions(void 0, flatSessions) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      active.length === 0 && ungrouped.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: styles4.empty, children: "\u8FD8\u6CA1\u6709\u5DE5\u4F5C\u533A\uFF0C\u70B9\u53F3\u4E0A \uFF0B \u65B0\u5EFA\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "div",
        {
          onDragOver: (e) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: styles4.wsTitle, children: "\u672A\u5F52\u7EC4" }),
...
function apply(raw) {
  ...
  const archiveSession = (sessionId) => {
    void (async () => {
      const ok = await requestConfirm({
        title: "\u5F52\u6863\u4F1A\u8BDD",
        message: "\u5F52\u6863\u540E\u8BE5\u4F1A\u8BDD\u4F1A\u4ECE\u5DE5\u4F5C\u533A\u5206\u7EC4\u3001\u4FA7\u680F\u548C\u6240\u6709\u5217\u8868\u9690\u85CF\uFF08\u5B98\u65B9\u5F52\u6863\u96C6\uFF0C\u4E0D\u53EF\u9006\uFF0C\u6682\u65E0\u6062\u590D\u5165\u53E3\uFF1B\u4ECD\u53EF\u901A\u8FC7\u641C\u7D22\u6253\u5F00\uFF09\u3002\u786E\u5B9A\u5F52\u6863\uFF1F",
        okLabel: "\u5F52\u6863"
      });
      if (!ok) return;
  ...
  const deleteWorkspace = (workspaceId) => {
    void (async () => {
      ...
      if (!ok) return;
      ctx.workspaces.delete(workspaceId).catch((error) => alertError("\u5220\u9664\u5931\u8D25", error));
    })();
  };
  const reorderWorkspace = (workspaceId, beforeWorkspaceId) => {
    ctx.workspaces.insertBefore(workspaceId, beforeWorkspaceId).catch((error) => alertError("\u6392\u5E8F\u5931\u8D25", error));
  };
  const reorderSession = (workspaceId, sessionId, beforeSessionId) => {
    ctx.workspaces.insertSessionBefore(workspaceId, sessionId, beforeSessionId).catch((error) => alertError("\u6392\u5E8F\u5931\u8D25", error));
  };
