...
const styles: Record<string, CSSProperties> = {
  ...
  input: {
    ...
    border: '1px solid rgba(28, 35, 51, 0.2)', outline: 'none', marginBottom: 12,
  },
  actions: { display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 4 },
  button: {
    fontSize: 12.5, padding: '5px 14px', borderRadius: 8,
    border: '1px solid rgba(28, 35, 51, 0.14)', background: '#ffffff', color: '#3c4659', cursor: 'pointer',
  },
  primary: {
    background: '#2d66f7', borderColor: '#2d66f7', color: '#ffffff',
  },
}
